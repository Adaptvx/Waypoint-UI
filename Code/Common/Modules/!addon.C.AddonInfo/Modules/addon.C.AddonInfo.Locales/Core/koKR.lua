...
function NS:Load()
	...
	do
		...
		L["Config - WaypointSystem"] = "위치 안내 설정"
		L["Config - WaypointSystem - Title"] = "위치 안내 설정"
		L["Config - WaypointSystem - Title - Subtext"] = "위치 및 거리·정보 표시 방식을 설정합니다."
		L["Config - WaypointSystem - Type"] = "활성화"
		L["Config - WaypointSystem - Type - Both"] = "모두"
		L["Config - WaypointSystem - Type - Waypoint"] = "위치 아이콘 표시"
		...
		L["Config - WaypointSystem - Waypoint"] = "위치 아이콘 설정"
		L["Config - WaypointSystem - Waypoint - Footer - Type"] = "정보 표시 옵션"
		...
		L["Config - Appearance"] = "UI 디자인 설정"
		L["Config - Appearance - Title"] = "UI 디자인 설정"
