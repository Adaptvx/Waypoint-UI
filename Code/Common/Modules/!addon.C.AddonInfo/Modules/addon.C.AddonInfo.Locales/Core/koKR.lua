...
function NS:Load()
	...
	do
		...
		L["Config - Appearance - Waypoint"] = "목표 지점 관련 설정"
		...
		L["Config - Appearance - Waypoint - Beam"] = "목표 지점 - 광선 표시"
		L["Config - Appearance - Waypoint - Beam - Alpha"] = "투명도"
		L["Config - Appearance - Waypoint - Footer - Alpha"] = "정보 글자 투명도 [거리 정보 글자]"
		L["Config - Appearance - Pinpoint"] = "목표 지점 툴팁"
		L["Config - Appearance - Pinpoint - Scale"] = "툴팁 크기"
		L["Config - Appearance - Visual"] = "화면 효과"
