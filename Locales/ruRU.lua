...
L["Config - ExtraFeature - TomTomSupport - Enable"] = "Отслеживание точек TomTom"
L["Config - ExtraFeature - TomTomSupport - Enable - Description"] = "Включает поддержку отслеживания точек TomTom с помощью интерфейса Waypoint. Чтобы начать отслеживание точки TomTom, ПКМ по любой точке TomTom на карте мира и выберите Установить как стрелку путевой точки в контекстном меню."
L["Config - ExtraFeature - TomTomSupport - AutoReplaceWaypoint"] = "Автозамена путевой точки"
L["Config - ExtraFeature - TomTomSupport - AutoReplaceWaypoint - Description"] = "Автоматически отслеживать точку TomTom с помощью интерфейса Waypoint."
