...
L["Config - WaypointSystem - Waypoint - Footer - Type - DestinationName"] = "목적지 이름"
...
L["Config - Appearance - Color - CustomColor - Other"] = "기타"
L["Config - Audio"] = "오디오"
...
L["Config - ExtraFeature - TomTomSupport - Enable"] = "TomTom 웨이포인트 추적"
L["Config - ExtraFeature - TomTomSupport - Enable - Description"] = "Waypoint UI에서 TomTom 웨이포인트 추적을 지원합니다. 월드 맵에서 TomTom 웨이포인트를 마우스 오른쪽 버튼으로 클릭한 후, 컨텍스트 메뉴에서 `웨이포인트 화살표로 설정`을 선택하면 해당 웨이포인트를 추적할 수 있습니다."
L["Config - ExtraFeature - TomTomSupport - AutoReplaceWaypoint"] = "자동 웨이포인트 교체"
L["Config - ExtraFeature - TomTomSupport - AutoReplaceWaypoint - Description"] = "Waypoint UI로 TomTom 웨이포인트를 자동으로 추적합니다."
L["Config - ExtraFeature - DugisSupport"] = "Dugi 퀘스트 도우미"
L["Config - ExtraFeature - DugisSupport - Enable"] = "Dugi 웨이포인트 추적"
L["Config - ExtraFeature - DugisSupport - Enable - Description"] = "Waypoint UI로 Dugi 퀘스트 도우미 웨이포인트 추적을 지원합니다."
L["Config - ExtraFeature - DugisSupport - AutoReplaceWaypoint"] = "자동 웨이포인트 교체"
L["Config - ExtraFeature - DugisSupport - AutoReplaceWaypoint - Description"] = "현재 Dugi 웨이포인트를 자동으로 추적합니다."
L["Config - ExtraFeature - SilverDragonSupport"] = "SilverDragon"
L["Config - ExtraFeature - SilverDragonSupport - Enable"] = "SilverDragon 웨이포인트 강화"
L["Config - ExtraFeature - SilverDragonSupport - Enable - Description"] = "SilverDragon의 내장 웨이포인트 옵션을 활성화해야 합니다."
L["Config - About"] = "정보"
...
-- Supported Add-ons
L["TomTom - ReplacePrompt"] = "현재 웨이포인트를 TomTom 웨이포인트 \"%s\"로 교체하시겠습니까?"
L["TomTom - ReplacePrompt - Yes"] = "확인"
L["TomTom - ReplacePrompt - No"] = "취소"
L["DugisGuideViewerZ - ReplacePrompt"] = "현재 웨이포인트를 Dugi 웨이포인트 \"%s\"로 교체하시겠습니까?"
L["DugisGuideViewerZ - ReplacePrompt - Yes"] = "교체"
L["DugisGuideViewerZ - ReplacePrompt - No"] = "취소"
