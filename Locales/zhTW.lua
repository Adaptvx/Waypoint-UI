...
L["Config - General - Other - ResetButton"] = "重置回預設"
L["Config - General - Other - ResetPrompt"] = "你確定要重置所有設定嗎？"
...
L["Config - WaypointSystem - General - AlwaysShow"] = "永遠顯示"
L["Config - WaypointSystem - General - AlwaysShow - Description"] = "永遠顯示路徑點、標記點以及導航，即使使用者介面已隱藏。"
...
L["Config - WaypointSystem - Pinpoint - ShowInQuestArea"] = "在任務區域顯示"
L["Config - WaypointSystem - Pinpoint - ShowInQuestArea - Description"] = "允許在任務區域內顯示標記點。此選項可能會導致定位不准確。"
...
L["Config - Appearance - Navigator - DynamicDistance"] = "動態距離"
L["Config - Appearance - Navigator - DynamicDistance - Description"] = "允許導航器根據視野縮放調整其距離。"
L["Config - Appearance - Color"] = "顏色"
L["Config - Appearance - Color - CustomColor"] = "使用自訂顏色"
L["Config - Appearance - Color - CustomColor - Color"] = "顏色"
L["Config - Appearance - Color - CustomColor - TintIcon"] = "染色圖示"
L["Config - Appearance - Color - CustomColor - Reset"] = "重設"
L["Config - Appearance - Color - CustomColor - Quest - Complete - Default"] = "普通任務"
L["Config - Appearance - Color - CustomColor - Quest - Complete - Repeatable"] = "可重複任務"
L["Config - Appearance - Color - CustomColor - Quest - Complete - Important"] = "重要任務"
L["Config - Appearance - Color - CustomColor - Quest - Incomplete"] = "未完成任務"
...
L["Config - Audio - Customize - UseCustomAudio - NewUserNavigation"] = "當開始 /路徑導航時..."

L["Config - ExtraFeature"] = "額外功能"
L["Config - ExtraFeature - Title"] = "額外功能"
L["Config - ExtraFeature - Title - Subtext"] = "管理額外的功能。"
L["Config - ExtraFeature - Pin"] = "地圖標記"
L["Config - ExtraFeature - Pin - AutoTrackPlacedPin"] = "自動追蹤標記"
L["Config - ExtraFeature - Pin - AutoTrackPlacedPin - Description"] = "當一個標記放置在世界地圖時自動追蹤。"
L["Config - ExtraFeature - Pin - AutoTrackChatLinkPin"] = "自動追蹤來自連結的標記"
