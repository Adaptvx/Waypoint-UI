...
L["Config - ExtraFeature - TomTomSupport - AutoReplaceWaypoint - Description"] = "自动使用TomTom路径点替换插件的路径点。"
...
L["Guide Pin Assistant - ReplacePrompt - Yes"] = "确定"
L["Guide Pin Assistant - ReplacePrompt - No"] = "取消"

-- Supported Add-ons
L["TomTom - ReplacePrompt"] = "你确定使用TomTom的路径点\"%s\"替换当前路径点吗？"
L["TomTom - ReplacePrompt - Yes"] = "确定"
