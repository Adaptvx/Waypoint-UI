...
L["Config - WaypointSystem - General - BackgroundPreview"] = "Pré-visualização do plano de fundo"
...
L["Config - Appearance - Navigator - DynamicDistance"] = "Distância Dinânamica"
